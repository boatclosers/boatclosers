...
// - 10 professional legal documents with auto-populated data
...
export default function BoatCloserDemo() {
  ...
  // Parse URL for shared transaction data on load
  useEffect(() => {
      ...
      <div className="max-w-md w-full text-center">
        ...
        <div className="bg-white/20 backdrop-blur rounded-2xl p-6 mb-8 text-left">
          ...
          <div className="space-y-3 text-green-50">
            ...
            <div className="flex justify-between">
              <span>Purchase Price</span>
              <span className="font-medium text-white">${parseInt(termsData.purchasePrice).toLocaleString()}</span>
            </div>
            <div className="flex justify-between">
